...
X = spambase.data.features.to_numpy()  # Converts the DataFrame to numpy array
...
filename = os.path.join(data_dir, f"spam_{method}.csv")
...
if isinstance(best_model, (RandomForestClassifier, BalancedRandomForestClassifier)):
    ...
    filename2 = os.path.join(data_dir, f"spam_decision_trees_{method}.csv")
